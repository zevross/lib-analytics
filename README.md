...
This repo is the `analytics` package within the original forked repository. We made a small edit to `types.d.ts` for compatibility with
TypeScript 2.3.4.
